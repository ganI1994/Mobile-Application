...
<MobileElementEntity>
   ...
   <name>android.widget.Image - FMCG-App-banner</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'FMCG-App-banner' or . = 'FMCG-App-banner')]</locator>
