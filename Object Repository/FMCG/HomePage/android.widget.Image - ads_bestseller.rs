...
<MobileElementEntity>
   ...
   <name>android.widget.Image - ads_bestseller</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Image' and (@text = 'ads_bestseller' or . = 'ads_bestseller')]</locator>
