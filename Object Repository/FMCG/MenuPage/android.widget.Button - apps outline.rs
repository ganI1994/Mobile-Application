...
<MobileElementEntity>
   ...
   <name>android.widget.Button - apps outline</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'apps outline' or . = 'apps outline')]</locator>
