...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Frozen Foods</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Frozen Foods' or . = 'Frozen Foods')]</locator>
