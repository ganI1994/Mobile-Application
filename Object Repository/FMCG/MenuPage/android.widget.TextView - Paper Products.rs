...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - Paper Products</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Paper Products' or . = 'Paper Products')]</locator>
